...
<div class = "blue">
 ...
 > `r icon::fa_search(colour = "#1FA67A")`: Cómo generar un _directory tree_ automatizado en [Windows](t.ly/c58k){target="_blank"},[linux](t.ly/WlMC){target="_blank"} y [MacOS](t.ly/ZCXK){target="_blank"}
...
Ver aquí: https://data.princeton.edu/stata/markdown
...
Para el control de versiones de códigos existen distintas herramientas, donde quizás la más conocida en el mundo de la programación es Git...
